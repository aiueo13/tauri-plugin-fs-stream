...
```bash
pnpm add tauri-plugin-fs-stream-api@0.3.0 -E
# or
npm install tauri-plugin-fs-stream-api@0.3.0 --save-exact
# or
yarn add tauri-plugin-fs-stream-api@0.3.0 --exact
```
